function new_activation = update_activation(weight_matrix, act_linear, selected_weights, selected_activation, coordinatesofneighbours, p, q, Cs, M, Cp, input)
...
fraction = individual_act ./ competition;             %same as above
